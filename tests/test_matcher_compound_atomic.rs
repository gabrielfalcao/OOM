...
#[test]
fn test_compound_atomic_one_or_more_and_literals() -> Result<()> {
    let mut state = State::new("O1");
    let first = Production::CompoundAtomic(
...
#[test]
fn test_compound_atomic_one_or_more_and_literals_mismatch() -> Result<()> {
